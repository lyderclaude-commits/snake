...
const raw = [
  {
    ...
    layers: [
      ...
      { type: 'image', id: 'frame', src: 'https://wakabileguide.com/frames/jy-serai.png' },
      {
        ...
        rect: { x: 0.25, y: 0.795, w: 0.48, h: 0.09 },
        size: 0.058, align: 'left', color: 'brand.paper', font: 'display',
      },
      {
        type: 'text', id: 'event', editable: true, placeholder: "Nom de l'événement",
        value: 'Festival des Divinités Noires', maxLength: 42,
        rect: { x: 0.25, y: 0.888, w: 0.48, h: 0.055 },
        size: 0.03, align: 'left', color: 'brand.paper', font: 'body',
      },
    ],
  ...
  },
  {
    ...
    layers: [
      ...
      { type: 'image', id: 'frame', src: 'https://wakabileguide.com/frames/bon-plan.png' },
      {
        ...
        rect: { x: 0.25, y: 0.79, w: 0.48, h: 0.08 },
        size: 0.05, align: 'left', color: 'brand.paper', font: 'display',
      },
      {
        ...
        rect: { x: 0.25, y: 0.872, w: 0.48, h: 0.05 },
        size: 0.026, align: 'left', color: 'brand.paper', font: 'body',
      },
    ],
    export: { formats: ['1:1'], maxPx: 2048 },
    share: {
  ...
  },
  {
    ...
    layers: [
      ...
      },
      {
        ...
        rect: { x: 0.25, y: 0.826, w: 0.48, h: 0.06 },
        size: 0.032, align: 'left', color: 'brand.paper', font: 'display',
      },
      {
        type: 'text', id: 'who', editable: true, placeholder: 'Ton prénom',
        value: 'Kossi', maxLength: 22,
        rect: { x: 0.25, y: 0.884, w: 0.48, h: 0.04 },
        size: 0.02, align: 'left', color: 'brand.paper', font: 'body',
      },
    ],
