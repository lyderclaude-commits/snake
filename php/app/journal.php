...
const JOURNAL_ACTIONS = [
    ...
    'campagne.supprimee'  => 'a supprimé une campagne e-mail',
    'carnet.importe'      => 'a importé des adresses dans une liste',
    'carnet.supprime'     => 'a supprimé des adresses du carnet',
    'carnet.liste'        => 'a supprimé une liste du carnet',
    ...
    'facture.emise'       => 'a émis une facture',
    'facture.avoir'       => 'a émis un avoir',
