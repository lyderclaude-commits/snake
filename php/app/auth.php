...
const FORMULES = [
    'decouverte' => [
        ...
        'telegram_par_mois' => 0, 'whatsapp_par_mois' => 0,
    ...
    'croissance' => [
        ...
        'telegram_par_mois' => 10000, 'whatsapp_par_mois' => 2000,
        'sans_filigrane' => true, 'koris' => true, 'redirection' => true,
    ...
    'mouvement' => [
        ...
        'telegram_par_mois' => -1, 'whatsapp_par_mois' => -1,
        'sans_filigrane' => true, 'koris' => true, 'redirection' => true,
        'stats' => 'completes', 'ciblage' => true,
...
const OFFRE_LIGNES = [
    ...
    'whatsapp_par_mois' => ['Messages WhatsApp', 'compteur',
        'Remis à zéro le 1er de chaque mois. WhatsApp n’écrit qu’en tête-à-tête, à des numéros qui ont donné leur accord, et Meta vous facture chaque message.'],
