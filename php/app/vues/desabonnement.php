...
<div class="etroit">
  <?php if ($fait): ?>
    <div class="carte" style="text-align:center">
      ...
      service, comme la confirmation d’adresse ou la décision sur un décor, continuent : ce sont
      des réponses à vos propres actions, pas de la publicité.</p>
  ...
  <?php else: ?>
    <div class="carte">
      ...
      comme la confirmation d’adresse ou la décision sur un décor, ne sont pas concernés.</p>
